  ...
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <div class="px-3 pb-3">
        ...
        >
          ...
          <span>v<span data-system-app-version>6.6.1</span></span>
        </button>
      </div>
    </aside>
    <main class="main-panel">
      ...
      <header class="topbar d-flex justify-content-between align-items-center">
        ...
        <span class="small text-body-secondary">Baseline <span data-system-app-version>6.6.1</span> · MariaDB Schema <span data-system-schema-version data-system-live>2</span></span>
      </header>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <dl class="row mb-0">
            ...
            <dd class="col-7" data-system-app-version>6.6.1</dd>
